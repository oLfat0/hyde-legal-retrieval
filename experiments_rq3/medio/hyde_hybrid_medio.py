"""hyde_hybrid_medio.py — RQ3: HyDE + Hybrid, cenario medio"""
...
CONFIG_NAME  = "hyde_hybrid_rq3_medio"
TOP_K, KS    = 10, [1, 5, 10]
RESULTS_DIR  = "results_rq3"

def run() -> dict:
    print(f"\n{'#'*55}")
    print(f"  RQ3 — HyDE + Hybrid | cenario: medio")
    print(f"  Indice: 501 documentos (RQ3)")
    print(f"  BM25: query original qi")
    print(f"{'#'*55}\n")

    mean_emb, cdac_order = run_pipeline(granul="medio")
