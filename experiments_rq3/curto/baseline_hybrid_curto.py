"""baseline_hybrid_curto.py — RQ3: Baseline + Hybrid, cenario curto"""
...
CONFIG_NAME  = "baseline_hybrid_rq3_curto"
TOP_K, KS    = 10, [1, 5, 10]
...
def run() -> dict:
    ...
    print(f"\n{'#'*55}")
    print(f"  RQ3 — Baseline + Hybrid | cenario: curto")
    ...
    emb      = encode_texts(query_texts, model, tokenizer, desc=f"Enc baseline hybrid curto")
