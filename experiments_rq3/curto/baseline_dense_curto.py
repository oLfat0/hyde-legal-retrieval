"""baseline_dense_curto.py — RQ3: Baseline + Dense, cenario curto"""
...
CONFIG_NAME  = "baseline_dense_rq3_curto"
TOP_K, KS    = 10, [1, 5, 10]
...
def run() -> dict:
    ...
    print(f"\n{'#'*55}")
    print(f"  RQ3 — Baseline + Dense | cenario: curto")
    ...
    emb      = encode_texts(query_texts, model, tokenizer, desc=f"Enc baseline curto")
